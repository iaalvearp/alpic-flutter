...
describe('WeatherService', () => {
  it('obtains coordinates and maps provider data', async () => {
  ...
  it('rejects an image without coordinates', async () => {
    const service = new WeatherService(
  ...
  it('maps invalid provider data to 502', async () => {
    const service = new WeatherService(
      imageServiceWith(imageWithCoordinates()),
  ...
  it('returns 404 when the image is not visible to the actor', async () => {
    const service = new WeatherService(
